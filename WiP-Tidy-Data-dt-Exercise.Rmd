...
# Rename column Country.Name into Country and Country.Code into Code
...
# Reshape to long format: for each country (column) data must becomes a row, and remove the missing data
WP <- melt(wip,
           ...
           value.name = c("pctWiP"),
           na.rm = TRUE)
# Creating numeric variable of Year and a Ratio of men to women in parlament
